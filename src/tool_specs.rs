...
pub use crate::dispatch::tool_specs::{
    ...
    TOOL_DISPATCH_REJECT, TOOL_DISPATCH_STATUS, TOOL_GITHUB_APPROVE_COMMENT,
...
mod tests {
    use super::{
        ...
        TOOL_DISPATCH_EXECUTE, TOOL_DISPATCH_IMPORT_HANDOFF, TOOL_DISPATCH_RECORD_OUTCOME,
        TOOL_DISPATCH_REJECT, TOOL_DISPATCH_STATUS, TOOL_GITHUB_APPROVE_COMMENT,
        TOOL_GITHUB_DRAFT_FINAL_COMMENT, TOOL_GITHUB_DRAFT_TRACKING_COMMENT,
        TOOL_GITHUB_INTERACTIONS, TOOL_GITHUB_POST_COMMENT, TOOL_GITHUB_REJECT_COMMENT,
        TOOL_GITHUB_RETRY_COMMENT, TOOL_MEMORY_DREAMS_LIST, TOOL_MEMORY_DREAM_SHOW,
        TOOL_MEMORY_HINTS_LIST, TOOL_MEMORY_HINT_UPDATE, TOOL_MEMORY_RECALL, TOOL_MEMORY_STATUS,
        TOOL_MEMORY_TOMBSTONE, TOOL_PREPARE, TOOL_READ_CONTEXT, TOOL_SCOUT,
        TOOL_SESSIONS_APPROVE_MUTATION, TOOL_SESSIONS_ARCHIVE, TOOL_SESSIONS_FORK,
