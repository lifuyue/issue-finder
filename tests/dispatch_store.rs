...
use issue_finder::dispatch::{
    ...
    DispatchFailureClass, DispatchOutcomeKind, DispatchRunStatus, DispatchStore, DispatchTaskClass,
    DispatchValidationOutcome, GitHubInteractionStatus, GitHubInteractionType, IssueTaskPackage,
    IssueTaskPackageIssue, IssueTaskStatus, MemoryEventType, NewAgentCapability, NewAgentEvent,
    NewAgentProfile, NewAgentSessionLink, NewApprovalRequest, NewArtifact, NewDispatchRun,
